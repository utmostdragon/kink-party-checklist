...
It's still slightly under construction and will be irregularly updated.

Pull requests welcome :) 

~~German version / [Deutschsprachige Fassung](german-kink-party-checklist.md)~~ 
# Content

- [General Tips](##general-tips)
- [Emergency Information](##emergency-information)
- [Things to do before the event](##things-to-do-before-the-event)
- [Payment and Documents](##payment-and-documents)
- [Hygiene](##hygiene)
- [Outfit](##outfit)
- [Toys](##toys)
  - [Sex Toys](###sex-toys)
...
Each location and scene might have their local customs or code of conducts, so these are rather obvious things:

- be nice to other people
- respect other peoples boundaries
- Help each other out
- Don't disrupt other peoples scenes
- Clean up after yourself (And read how to apply the disinfectant so it actually works)

- Remember to drink enough. Dehydration can end a really nice session. 
- Have a snack ready. Some people need sugar or salt or both

## Emergency Information

If you're in an emergency shout "MAYDAY". That should be recognized about anywhere, "RED" should also do the trick. Basically anything except "No", "Help" or general screaming noises. 
Some locations or events have explicitly stated a universal safeword that can be used by anyone to signal the need for help. 

If you need help, feel unsafe, unsure about things, please talk to other people and call for help, there are many, many friendly people around. 


## Things to do before the event

- Check the prerequisites and fulfill them. Buy a ticket, write an introduction, hit the "attend" button or just discover that there are none and you are supposed to just show up. 
- If you're new: you might want to introduce yourself to the organizers and if you have any questions, ask them. 
- Make yourself familiar with the event - what are the rules, how's the location, is there a dresscode, can you get food and drinks, do you know people there,... 
- Check how you get there, how you get back home, if you can or have to stay somewhere overnight, etc.
...
- Feed the cats.
- Do yourself a favor and make your home nice, have food and drinks ready for the next day
- Take a shower
...
Usually, you can get changed at the location. If there is a dresscode, you can show a picture or just the clothes. If you are unsure about the dresscode, ask the organizers before attending. 
